 ...
 * generated in the com.udea.cliente.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _BuscarProducto_QNAME = new QName("http://servicio.udea.com/", "BuscarProducto");
    private final static QName _BuscarProductoResponse_QNAME = new QName("http://servicio.udea.com/", "BuscarProductoResponse");
    private final static QName _ConsultarProducto_QNAME = new QName("http://servicio.udea.com/", "ConsultarProducto");
    private final static QName _ConsultarProductoResponse_QNAME = new QName("http://servicio.udea.com/", "ConsultarProductoResponse");
    private final static QName _IngresarProducto_QNAME = new QName("http://servicio.udea.com/", "IngresarProducto");
    private final static QName _IngresarProductoResponse_QNAME = new QName("http://servicio.udea.com/", "IngresarProductoResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.udea.cliente.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.udea.com/", name = "BuscarProducto")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.udea.com/", name = "BuscarProductoResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.udea.com/", name = "ConsultarProducto")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.udea.com/", name = "ConsultarProductoResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.udea.com/", name = "IngresarProducto")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.udea.com/", name = "IngresarProductoResponse")
